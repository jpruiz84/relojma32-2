...
#DEFINE	 TIEMPOLCD	d'20'			; Define el tiempo en n*500ms de la duración
						; de la luz del LCD
#DEFINE  TCONTILCD	d'10'			; Define el tiempo en n*500ms de la nueva inicializacion LCD
...
; ZONA DE CÓDIGOS ******************************************************************************************
	...
	INCLUDE "D:\Electronica\RelojMA\Librerias\TECLADO.INC"
...
;	MOVWF	DiaSemana
	...
	BSF	BANDILCD,0		; Inicializa la bandera de ILCD en 1 para decir que no se ha
					; dado la segunda inicialización
	MOVLW	TCONTILCD		; Inicializa el contador del tiempo del LCD
	MOVWF	CONTILCD	
...
LCD_Inicializa2
	CALL	LCD_Inicializa
	CALL	LCD_Inicializa
	BCF	BANDILCD,0		; Ya inicializado se coloca esta bandera en cero.
;	CALL	Retardo_100ms
;	BSF	PINTIMBRE
;	CALL	Retardo_200ms
;	BCF	PINTIMBRE
...
ARELOJ
	...
	BTFSS	BANDILCD,0		; Si ya se inicializo el LCD por segunda vez, BANDILCD = 0, sigue
	GOTO	ARELOJ1A		;
	DECF	CONTILCD,F		; Si no se ha inicializado por segunda vez se decrementa CONTILCD y 
	BTFSC	STATUS,Z		; se inicializa cuando llega a cero
	CALL	LCD_Inicializa2		; Inicializa la pantalla y graba el logo en su memoria
...
TESTEARALARMA
	...
	MOVF	NALARMA,W		; Lee el tipo de timbrado
	BCF	STATUS,C
	RLF	NALARMA,W
	CALL	EEDIR
	CALL	EELEER
...
; ZONA DE LIBRERIAS ****************************************************************************************
	...
	INCLUDE "D:\Electronica\RelojMA\Librerias\LCD_4BITOPD877.INC"
	INCLUDE "D:\Electronica\RelojMA\Librerias\RETARDOS.INC"
	INCLUDE "D:\Electronica\RelojMA\Librerias\BUS_I2C.INC"
	INCLUDE "D:\Electronica\RelojMA\Librerias\DS1307.INC"
	INCLUDE "D:\Electronica\RelojMA\Librerias\EEPROM.INC"
...
; PAGINA 1 ****************************************************************************************************
	...
	INCLUDE "D:\Electronica\RelojMA\Librerias\BINAD99.INC"
